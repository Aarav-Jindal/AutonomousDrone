...
class Hover(Node):
    def __init__(self):
        ...
        self.height_tolerance = 0.1  # Tolerance in meters
        ...
        self.create_subscription(VehicleOdometry, '/fmu/out/vehicle_odometry', self.odometry_callback, qos_profile_subscriber)
        # self.create_subscription(Bool, '/should_hover, ')
        
        self.control_publisher_ = self.create_publisher(TrajectorySetpoint, '/fmu/in/trajectory_setpoint', qos_profile_publisher)
        self.offboard_publisher_ = self.create_publisher(OffboardControlMode, '/fmu/in/offboard_control_mode', qos_profile_publisher)
        self.cmd_publisher_ = self.create_publisher(VehicleCommand, '/fmu/in/vehicle_command', qos_profile_publisher)
    ...
    def control_loop(self):
        ...
        if abs(height_error) > self.height_tolerance:
            ...
            trajectory_setpoint_msg.position = [0.0, 0.0, float(self.target_height)]  
